<template>
    <div id="About">
        <b-container>
            ...
            <b-row class="parts">
                <b-col class="text" v-for="(text,index) in DescriptionText" :key="index">{{text.part}}</b-col>
            </b-row>
